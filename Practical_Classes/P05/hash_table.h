...
{
  int index;
  hash_table_node *item;
  // place your code here
  // 1. calcular o index a partir da chave
  ...
  return NULL;
  // 2. verificar se hashtable[index] é nulo --> se sim entao a chave nao esta na hashtable --> return NULL
  //    se nao é nulo --> verificar se hashtable[index] == key
  //          se sim, encontrei o no desejado
  //          se nao --> continuar a percorrer a lista ate esta terminar ou ate encontrar o no desejado
  // quando encontrar o no devolve o ponteiro para essa posição no array
}
...
{
  // place your code here
  // 1. calcular o index a partir de n->key
  int index = hash_function(n->key);
  // 2. n_next = hashtable[index];
